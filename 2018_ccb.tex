...
\captionof{figure}{\textit{Supervised heatmap} of biomarker contributions to the
  ATE.}
\end{center}

\begin{center}
\vspace*{-0.57cm}  % CHANGE THIS TO ALIGN IMAGES
\includegraphics[scale=0.35]{topGenesHeatmap}
\captionof{figure}{Enhanced error rate control of the variance-moderated TMLE
  of the ATE.}
\end{center}
